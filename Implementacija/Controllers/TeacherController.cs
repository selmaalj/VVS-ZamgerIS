...
namespace ooadproject.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,ID,FirstName,LastName,Username,Password,BirthDate,Email")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,ID,FirstName,LastName,Username,Password,BirthDate,Email")] Teacher teacher)
        {
            if (id != teacher.ID)
            {
                return NotFound();
